# Terms of Service for ConsignTracker

**Last updated: March 17, 2026**

## Acceptance of Terms

By downloading or using ConsignTracker ("the App"), you agree to these Terms
of Service. If you do not agree, do not use the App.

## Description of Service

ConsignTracker is an inventory tracking app for artists, makers, and sellers
who consign goods at stores, galleries, markets, and similar venues. It allows
you to track items, quantities, sale status, and payments.
...
You retain ownership of all content (photos, item data, notes) you add to
the App. By using the App, you grant us a limited license to store and
process your content solely to provide the service to you.

You are responsible for ensuring you have the right to upload any photos
or content you add to the App.

## Subscriptions and Payments

ConsignTracker may offer optional paid subscription features ("Premium"):
...
guarantee that the App will be error-free, uninterrupted, or that data
will never be lost. **Always maintain your own backups of important inventory
data** using the Export feature in Settings.
...
Terms. You may delete your account at any time from the app's Settings screen.
